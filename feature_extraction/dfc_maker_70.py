...
pickle_path = os.path.join(parent_dir, 'dfc_cc200_70') # path to desired subdirectory for .pkl storage

pickle_party = DFC(phenotype_df, roi_path, pickle_path) # DFC class instance iniatlise

pickle_party.pickle_jar(70) # make .pkl files containing dFC matrices window length of 70
